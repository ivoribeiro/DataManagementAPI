...
${OBJECTDIR}/AlertaController.o: AlertaController.c 
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.c) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/AlertaController.o AlertaController.c

${OBJECTDIR}/AlertaModel.o: AlertaModel.c 
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.c) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/AlertaModel.o AlertaModel.c
...
${OBJECTDIR}/EstadoController.o: EstadoController.c 
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.c) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/EstadoController.o EstadoController.c

${OBJECTDIR}/EstadoModel.o: EstadoModel.c 
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.c) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/EstadoModel.o EstadoModel.c
...
${OBJECTDIR}/RoleController.o: RoleController.c 
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.c) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/RoleController.o RoleController.c

${OBJECTDIR}/RoleModel.o: RoleModel.c 
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.c) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/RoleModel.o RoleModel.c
...
${OBJECTDIR}/json.o: json.c 
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.c) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/json.o json.c

${OBJECTDIR}/jsonADT.o: jsonADT.c 
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.c) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/jsonADT.o jsonADT.c

${OBJECTDIR}/loginPartial.o: loginPartial.c 
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.c) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/loginPartial.o loginPartial.c
...
${OBJECTDIR}/test_json.o: test_json.c 
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.c) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/test_json.o test_json.c
